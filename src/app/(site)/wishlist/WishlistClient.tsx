...
const Wishlist = () => {
  ...
  const { data: wishlist, isLoading } = useWishlist({ search: querySearch })
  ...
  return (
    <Container size="xl" mt={{ base: 70, md: 100 }}>
      ...
      <div className="sm:flex justify-between items-center mb-6">
        <div>
          <h2 className="text-midnight_text text-2xl lg:text-4xl font-semibold mb-1">Wishlist</h2>
          <Text size="sm" c="dimmed">
            Browse and manage your saved products
          </Text>
        </div>
