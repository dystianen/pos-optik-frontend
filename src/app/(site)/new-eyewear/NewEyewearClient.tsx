...
const NewEyewearClient = () => {
  ...
  const { data: products, isLoading } = useNewEyeWear({ search: querySearch, limit: 12 })
  ...
  return (
    <Container size="xl" mt={{ base: 70, md: 100 }}>
      ...
      <div className="sm:flex justify-between items-center mb-6">
        <div>
          <h2 className="text-midnight_text text-2xl lg:text-4xl font-semibold mb-1">New Eyewear</h2>
          <Text size="sm" c="dimmed">
            Discover our latest eyewear collections
          </Text>
        </div>
